...
- [oral+poster] [A Learnable Similarity Metric for Transfer Learning with Dynamics Mismatch](https://openreview.net/forum?id=78n3SG6xMY)
...
- [poster only] [Generalized Planning in PDDL Domains with Pretrained Large Language Models](https://openreview.net/forum?id=ilHDGs2clY)
